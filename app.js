((window) => {
  ...
  const getData = (endpoint_url) => {
    ...
    request.addEventListener('error', (e) => {
      alert("There was an error retrieving data from https://www.grailed.com/api/listings/grailed, most likely due to a missing Access-Control-Allow-Origin header. Use the Chrome plugin Allow-Control-Origin: * to avoid this.");
    });
